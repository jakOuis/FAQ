...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_faq_5fclient_2eproto
...
struct TableStruct_faq_5fclient_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_faq_5fclient_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::faq_client::Empty* Arena::CreateMaybeMessage<::faq_client::Empty>(Arena*);
template<> ::faq_client::InitRequest* Arena::CreateMaybeMessage<::faq_client::InitRequest>(Arena*);
template<> ::faq_client::InitResponse* Arena::CreateMaybeMessage<::faq_client::InitResponse>(Arena*);
template<> ::faq_client::LogMsg* Arena::CreateMaybeMessage<::faq_client::LogMsg>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace faq_client {
