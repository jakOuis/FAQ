 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientReaderInterface< ::faq_client::InitResponse>> Init(::grpc::ClientContext* context, const ::faq_client::InitRequest& request) {
      return std::unique_ptr< ::grpc::ClientReaderInterface< ::faq_client::InitResponse>>(InitRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::faq_client::InitResponse>> AsyncInit(::grpc::ClientContext* context, const ::faq_client::InitRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::faq_client::InitResponse>>(AsyncInitRaw(context, request, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::faq_client::InitResponse>> PrepareAsyncInit(::grpc::ClientContext* context, const ::faq_client::InitRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::faq_client::InitResponse>>(PrepareAsyncInitRaw(context, request, cq));
    }
    class experimental_async_interface {
     public:
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void Init(::grpc::ClientContext* context, ::faq_client::InitRequest* request, ::grpc::ClientReadReactor< ::faq_client::InitResponse>* reactor) = 0;
      #else
      virtual void Init(::grpc::ClientContext* context, ::faq_client::InitRequest* request, ::grpc::experimental::ClientReadReactor< ::faq_client::InitResponse>* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  ...
  private:
    ...
    virtual ::grpc::ClientReaderInterface< ::faq_client::InitResponse>* InitRaw(::grpc::ClientContext* context, const ::faq_client::InitRequest& request) = 0;
    virtual ::grpc::ClientAsyncReaderInterface< ::faq_client::InitResponse>* AsyncInitRaw(::grpc::ClientContext* context, const ::faq_client::InitRequest& request, ::grpc::CompletionQueue* cq, void* tag) = 0;
    virtual ::grpc::ClientAsyncReaderInterface< ::faq_client::InitResponse>* PrepareAsyncInitRaw(::grpc::ClientContext* context, const ::faq_client::InitRequest& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientReader< ::faq_client::InitResponse>> Init(::grpc::ClientContext* context, const ::faq_client::InitRequest& request) {
      return std::unique_ptr< ::grpc::ClientReader< ::faq_client::InitResponse>>(InitRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::faq_client::InitResponse>> AsyncInit(::grpc::ClientContext* context, const ::faq_client::InitRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReader< ::faq_client::InitResponse>>(AsyncInitRaw(context, request, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::faq_client::InitResponse>> PrepareAsyncInit(::grpc::ClientContext* context, const ::faq_client::InitRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncReader< ::faq_client::InitResponse>>(PrepareAsyncInitRaw(context, request, cq));
    }
    class experimental_async final :
     ...
     public:
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void Init(::grpc::ClientContext* context, ::faq_client::InitRequest* request, ::grpc::ClientReadReactor< ::faq_client::InitResponse>* reactor) override;
      #else
      void Init(::grpc::ClientContext* context, ::faq_client::InitRequest* request, ::grpc::experimental::ClientReadReactor< ::faq_client::InitResponse>* reactor) override;
      #endif
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientReader< ::faq_client::InitResponse>* InitRaw(::grpc::ClientContext* context, const ::faq_client::InitRequest& request) override;
    ::grpc::ClientAsyncReader< ::faq_client::InitResponse>* AsyncInitRaw(::grpc::ClientContext* context, const ::faq_client::InitRequest& request, ::grpc::CompletionQueue* cq, void* tag) override;
    ::grpc::ClientAsyncReader< ::faq_client::InitResponse>* PrepareAsyncInitRaw(::grpc::ClientContext* context, const ::faq_client::InitRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status Init(::grpc::ServerContext* context, const ::faq_client::InitRequest* request, ::grpc::ServerWriter< ::faq_client::InitResponse>* writer);
  };
  ...
  class WithAsyncMethod_Init : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status Init(::grpc::ServerContext* /*context*/, const ::faq_client::InitRequest* /*request*/, ::grpc::ServerWriter< ::faq_client::InitResponse>* /*writer*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestInit(::grpc::ServerContext* context, ::faq_client::InitRequest* request, ::grpc::ServerAsyncWriter< ::faq_client::InitResponse>* writer, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class ExperimentalWithCallbackMethod_Init : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_Init() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(1,
          new ::grpc::internal::CallbackServerStreamingHandler< ::faq_client::InitRequest, ::faq_client::InitResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::faq_client::InitRequest* request) { return this->Init(context, request); }));
    }
    ...
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    virtual ::grpc::ServerWriteReactor< ::faq_client::InitResponse>* Init(
      ::grpc::CallbackServerContext* /*context*/, const ::faq_client::InitRequest* /*request*/)
    #else
    virtual ::grpc::experimental::ServerWriteReactor< ::faq_client::InitResponse>* Init(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::faq_client::InitRequest* /*request*/)
    #endif
      { return nullptr; }
  };
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  ...
  class WithSplitStreamingMethod_Init : public BaseClass {
   ...
   public:
    ...
    virtual ::grpc::Status StreamedInit(::grpc::ServerContext* context, ::grpc::ServerSplitStreamer< ::faq_client::InitRequest,::faq_client::InitResponse>* server_split_streamer) = 0;
  };
  typedef WithSplitStreamingMethod_Init<Service > SplitStreamedService;
  typedef WithStreamedUnaryMethod_Log<WithSplitStreamingMethod_Init<Service > > StreamedService;
};
