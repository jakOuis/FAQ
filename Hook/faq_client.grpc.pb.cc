...
Client::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_Init_(Client_method_names[1], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  {}
...
::grpc::ClientReader< ::faq_client::InitResponse>* Client::Stub::InitRaw(::grpc::ClientContext* context, const ::faq_client::InitRequest& request) {
  return ::grpc::internal::ClientReaderFactory< ::faq_client::InitResponse>::Create(channel_.get(), rpcmethod_Init_, context, request);
}

void Client::Stub::experimental_async::Init(::grpc::ClientContext* context, ::faq_client::InitRequest* request, ::grpc::experimental::ClientReadReactor< ::faq_client::InitResponse>* reactor) {
  ::grpc::internal::ClientCallbackReaderFactory< ::faq_client::InitResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_Init_, context, request, reactor);
}

::grpc::ClientAsyncReader< ::faq_client::InitResponse>* Client::Stub::AsyncInitRaw(::grpc::ClientContext* context, const ::faq_client::InitRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::internal::ClientAsyncReaderFactory< ::faq_client::InitResponse>::Create(channel_.get(), cq, rpcmethod_Init_, context, request, true, tag);
}

::grpc::ClientAsyncReader< ::faq_client::InitResponse>* Client::Stub::PrepareAsyncInitRaw(::grpc::ClientContext* context, const ::faq_client::InitRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncReaderFactory< ::faq_client::InitResponse>::Create(channel_.get(), cq, rpcmethod_Init_, context, request, false, nullptr);
}
...
Client::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::ServerStreamingHandler< Client::Service, ::faq_client::InitRequest, ::faq_client::InitResponse>(
          [](Client::Service* service,
             ::grpc::ServerContext* ctx,
             const ::faq_client::InitRequest* req,
             ::grpc::ServerWriter<::faq_client::InitResponse>* writer) {
...
::grpc::Status Client::Service::Init(::grpc::ServerContext* context, const ::faq_client::InitRequest* request, ::grpc::ServerWriter< ::faq_client::InitResponse>* writer) {
  (void) context;
  (void) request;
  (void) writer;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
